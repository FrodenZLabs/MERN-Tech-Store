...
const CreditPredictionPage = () => {
  ...
  useEffect(() => {
    ...
    // Introduce a small delay before fetching predictions
  ...
  return (
    <div className="max-w-4xl mx-auto my-10 p-8 bg-white shadow-xl rounded-lg border border-gray-200">
      {/* Title */}
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Risk Level Display */}
          <div className="text-center mt-6 bg-gray-100 p-6 rounded-lg shadow-lg">
