...
import Team1 from "../../assets/images/Landing Page/team-1.jpg";
import Team2 from "../../assets/images/Landing Page/team-2.jpg";
import Team3 from "../../assets/images/Landing Page/team-3.jpg";
    ...
    <section id="about-us" className="py-16 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mt-20 space-y-8">
          <h3 className="text-4xl font-bold text-center text-amber-500">
            Meet Our Team
          </h3>
        ...
        <div className="mt-16 space-y-8">
          <h3 className="text-3xl font-bold text-center text-amber-500">
            Our Core Values
          </h3>
